  ...
  return (
    <SafeAreaView style={[styles.area, { backgroundColor: COLORS.white }]}>
      <View style={[styles.container, { backgroundColor: COLORS.white }]}>
        ...
        >
          <Header title="Tracking SK26273729" />
        </View>
        <MapView
        ...
        >
          <View
            style={[styles.bottomContainer, { backgroundColor: COLORS.white }]}
          >
            <View style={styles.bottomTopContainer}>
              <Text
                style={[
                  styles.bottomTopTitle,
                  {
                    color: COLORS.greyscale900,
                  },
                ]}
              >
                package is on the ways...
              </Text>
              <Text
                style={[
                  styles.bottomTopSubtitle,
                  {
                ...
                <View style={styles.orderDetailsContainer}>
                  <View style={styles.orderViewContainer}>
                    ...
                    <View style={styles.orderView}>
                      ...
                      >
                        891 Glen Ridge St. Gainesville, VA 20155
                      </Text>
                    </View>
                  </View>
                  <Text
