...
import { deliveryReviews } from '@/data';
...
const WriteReview = () => {
                ...
                <TouchableWithoutFeedback
                    ...
                    <View style={[styles.modalContainer]}>
                        <View style={[styles.modalSubContainer, {
                            ...
                            />
                            <TextInput
                                placeholder="The shipping is so fast 🔥"
    ...
    */
    const renderContent = () => {
        ...
        const filteredReviews = selectedRating === "All" ? deliveryReviews : deliveryReviews.filter((review: any) => review.avgRating === selectedRating);
        return (
            <ScrollView
